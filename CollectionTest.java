...
public class CollectionTest {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i<=RCB.size()-1; i++)
		{
			System.out.print(RCB.get(i).getJn() + "\t");
			System.out.print(RCB.get(i).getName() + "\t");
			System.out.print(RCB.get(i).getRuns() + "\t");
			System.out.print(RCB.get(i).getWickets() + "\t");
			System.out.println(RCB.get(i).gettName());
		}
		...
		{
			System.out.print(PBKS.get(i).getJn() + "\t");
			System.out.print(PBKS.get(i).getName() + "\t");
			System.out.print(PBKS.get(i).getRuns() + "\t");
			System.out.print(PBKS.get(i).getWickets() + "\t");
			System.out.println(PBKS.get(i).gettName());
		}
		...
		{
			System.out.print(MI.get(i).getJn() + "\t");
			System.out.print(MI.get(i).getName() + "\t");
			System.out.print(MI.get(i).getRuns() + "\t");
			System.out.print(MI.get(i).getWickets() + "\t");
			System.out.println(MI.get(i).gettName());
		}
		...
		{
			System.out.print(GT.get(i).getJn() + "\t");
			System.out.print(GT.get(i).getName() + "\t");
			System.out.print(GT.get(i).getRuns() + "\t");
			System.out.print(GT.get(i).getWickets() + "\t");
			System.out.println(GT.get(i).gettName());
		}
